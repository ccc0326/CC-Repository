<template>
  <div>
      ...
      <el-row :gutter="20">
        <el-col :span="20">
          <el-button type="primary" @click="addDialogVisible = true" style="font-size: 22px;">
            <i class="el-icon-circle-plus" style="font-size: 24px;"></i> 添加类别
          </el-button>
        </el-col>
      </el-row>
        ...
        <el-table-column label="操作" width="240" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改电影类别" placement="top" :enterable="false" :open-delay="500">
              <el-button type="primary" @click="showEditDialog(scope.row.movieCategoryId)">
            ...
            <el-tooltip effect="dark" content="删除类别" placement="top" :enterable="false" :open-delay="500">
              <el-button type="danger" @click="deleteMovieCategoryById(scope.row.movieCategoryId)">
    ...
    <el-dialog title="添加类别" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addMovieCategory" style="font-size: 18px;"><i class="iconfont icon-r-yes" style="font-size: 24px;"></i> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改类别" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editMovieCategoryInfo" style="font-size: 18px;"><i class="iconfont icon-r-yes" style="font-size: 24px;"></i> 确 定</el-button>
      </span>
    </el-dialog>
