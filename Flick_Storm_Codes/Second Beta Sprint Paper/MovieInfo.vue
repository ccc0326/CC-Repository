  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20" class="row2">
        ...
        <el-col :span="24">
          <el-button type="primary" round @click="addDialogVisible = true" style="font-size: 22px;">
            <i class="el-icon-circle-plus-outline" style="font-size: 24px;"></i> 添加电影
          </el-button>
        </el-col>
      </el-row>
      ...
      <el-table-column label="操作" width="350" fixed="right">
        <template slot-scope="scope">
          ...
          <el-tooltip effect="dark" content="修改电影信息" placement="top" :enterable="false" :open-delay="500">
            <el-button type="primary" circle @click="isAbleEdit(scope.row.movieId)">
          ...
          <el-tooltip effect="dark" content="删除电影" placement="top" :enterable="false" :open-delay="500">
            <el-button type="danger" circle @click="isAbleDelete(scope.row.movieId)">
          ...
          <el-tooltip effect="dark" content="影片类别管理" placement="top" :enterable="false" :open-delay="500">
            <el-button type="warning" circle @click="showEditCategoryDialog(scope.row.movieId)">
...
export default {
  ...
  methods: {
    async showCommentsDialog(movieId) {
